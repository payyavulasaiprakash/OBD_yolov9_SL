...
#python train_dual.py --workers 8 --batch 4  --img 640 --epochs 1 --data data.yaml --weights yolov9-e.pt --cfg /content/yolov9/models/detect/yolov9.yaml --hyp data/hyps/hyp.scratch-high.yaml
#python train_dual.py --workers 8 --device 0 --batch 16 --data data/coco.yaml --img 640 --cfg models/detect/yolov9-c.yaml --weights '' --name yolov9-c --hyp hyp.scratch-high.yaml --min-items 0 --epochs 500 --close-mosaic 15
#python train_dual.py --workers 8 --batch 4  --img 640 --epochs 1 --data data.yaml --weights yolov9-e.pt --cfg models/detect/yolov9-c.yaml --hyp data/hyps/hyp.scratch-high.yaml
